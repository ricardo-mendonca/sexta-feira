...
interface IAppThemeProviderProps { children: React.ReactNode, titulo: string; }
export const LayoutBaseDePagina: React.FC<IAppThemeProviderProps> = ({ children, titulo }) => {
